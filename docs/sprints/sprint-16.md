...
| 137 | AI 评判 Skill：eval-judge | `skills/eval-judge/`：使用 AI 对比 actual vs expected 自由文本输出，打分 1-5 + 给出评估理由。AIOperationType 新增 `EVAL_JUDGE`。设计决策见 PHASE3-LAUNCH-PLAN.md §四 D22 |
