...
import { validateOutput } from "@/lib/ai/harness/output-validator";
import { checkInjection, sanitizeInput } from "@/lib/ai/harness/prompt-injection-guard";
import { registerPrompt, getPrompt, buildMessages } from "@/lib/ai/harness/prompt-manager";
import { getFallbackResult } from "@/lib/ai/harness/fallback-handler";
import { executeOperation } from "@/lib/ai/harness/index";
import { recognizeHomeworkSchema } from "@/lib/ai/harness/schemas/recognize-homework";
