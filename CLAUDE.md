...
- Sprint 计划: `docs/sprints/` | 路线图: `docs/ROADMAP.md` | 启动计划: `docs/PHASE2-LAUNCH-PLAN.md`
...
| 用户说 | 做什么 |
|--------|--------|
| "继续开发" / "项目状态" | git log + git status + 读 Sprint 文件 + npm test → 汇报等确认 |
