...
/**
 * Learning Brain 监控页（Sprint 15 US-057）
 *
 * 三个 Tab：
 *   1. 执行历史 — AdminLog(action="brain-run") 分页 + filter
 *   2. 学生状态 — 单学生最近 run + cooldown + cron
 *   3. 统计 — 最近 7 天聚合（总数/平均耗时/agent 分布/skipped top）
 */
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold">{avgDurationMs} ms</div>
          </CardContent>
        </Card>
      </div>
