...
import { recognizeHomeworkSchema, type RecognizeHomeworkOutput } from '@/lib/domain/ai/harness/schemas/recognize-homework'
import { gradeAnswerSchema } from '@/lib/domain/ai/harness/schemas/grade-answer'
