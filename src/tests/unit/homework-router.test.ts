...
import { enqueueRecognition, enqueueCorrectionPhotos, enqueueHelpGeneration } from "@/lib/infra/queue";
...
describe("homework.completeSession — error auto-record", () => {
  ...
  test("deduplicates: same content bumps totalAttempts", async () => {
    ...
    const { computeContentHash } = await import("@/lib/domain/content-hash");
